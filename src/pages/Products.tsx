    ...
    <div className="p-2">
      <div className="flex flex-col md:flex-row gap-4 mb-4">
        ...
        <select
          ...
          className="p-2 border rounded w-full md:w-1/4 dark:bg-gray-800 dark:text-white"
        >
      ...
      {loading ? (
        ...
        >
          <table className="min-w-full table-auto border dark:border-gray-700">
            <thead>
              <tr className="bg-gray-200 dark:bg-gray-800">
                ...
                <th className="p-2 border dark:border-gray-700">Tags</th>
              </tr>
            </thead>
            <tbody>
